                ...
                <div class="row fill-width">
                    <section class="column">
                        ...
                        <svg class="bar" xmlns="http://www.w3.org/2000/svg" width="220" height="8">
                            ...
                            <rect mask="url(#issues-bar)" x="0" y="0" width="12.571428571428571" height="8" fill="#238636"/>
                            <rect mask="url(#issues-bar)" x="12.571428571428571" y="0" width="7.542857142857144" height="8" fill="#56d364"/>
                            <rect mask="url(#issues-bar)" x="20.114285714285714" y="0" width="0" height="8" fill="#8B949E"/>
                            <rect mask="url(#issues-bar)" x="20.114285714285714" y="0" width="0" height="8" fill="#c9d1d9"/>
                            <rect mask="url(#issues-bar)" x="20.114285714285714" y="0" width="88.62857142857143" height="8" fill="#8957e5"/>
                            <rect mask="url(#issues-bar)" x="108.74285714285715" y="0" width="111.25714285714285" height="8" fill="#d2a8ff"/>
                        ...
                        <div class="followup legend field fill-width">
                            <div class="field">
                                ...
                                <span class="no-wrap">32 <small>open</small></span>
                            </div>
                            <div class="field">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width="16" height="16">
                                ...
                                <span class="no-wrap">318 <small>closed</small></span>
                            </div>
                            <div class="field">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width="16" height="16">
                        ...
                        <div class="followup legend field fill-width">
                            <div class="field">
                                ...
                                <span class="no-wrap">12 <small>open</small></span>
                            </div>
                            <div class="field">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width="16" height="16">
                                ...
                                <span class="no-wrap">177 <small>closed</small></span>
                            </div>
                            <div class="field">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width="16" height="16">
                    ...
                    <section class="column">
                        ...
                        <svg class="bar" xmlns="http://www.w3.org/2000/svg" width="220" height="8">
                            ...
                            <rect mask="url(#issues-bar)" x="0" y="0" width="0.22880915236609467" height="8" fill="#238636"/>
                            <rect mask="url(#issues-bar)" x="0.22880915236609467" y="0" width="1.71606864274571" height="8" fill="#56d364"/>
                            <rect mask="url(#issues-bar)" x="1.9448777951118046" y="0" width="0" height="8" fill="#8B949E"/>
                            <rect mask="url(#issues-bar)" x="1.6016640665626625" y="0" width="0.343213728549142" height="8" fill="#c9d1d9"/>
                            <rect mask="url(#issues-bar)" x="1.9448777951118044" y="0" width="1.2584503380135204" height="8" fill="#da3633"/>
                            <rect mask="url(#issues-bar)" x="3.203328133125325" y="0" width="22.76651066042642" height="8" fill="#ff7b72"/>
                            <rect mask="url(#issues-bar)" x="25.969838793551745" y="0" width="41.98647945917837" height="8" fill="#8957e5"/>
                            <rect mask="url(#issues-bar)" x="67.95631825273011" y="0" width="152.0436817472699" height="8" fill="#d2a8ff"/>
                        </svg>
                        <div class="field blue fill-width">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width="16" height="16">
                                <path fill-rule="evenodd" d="M5.5 3.5a2 2 0 100 4 2 2 0 000-4zM2 5.5a3.5 3.5 0 115.898 2.549 5.507 5.507 0 013.034 4.084.75.75 0 11-1.482.235 4.001 4.001 0 00-7.9 0 .75.75 0 01-1.482-.236A5.507 5.507 0 013.102 8.05 3.49 3.49 0 012 5.5zM11 4a.75.75 0 100 1.5 1.5 1.5 0 01.666 2.844.75.75 0 00-.416.672v.352a.75.75 0 00.574.73c1.2.289 2.162 1.2 2.522 2.372a.75.75 0 101.434-.44 5.01 5.01 0 00-2.56-3.012A3 3 0 0011 4z"/>
                        ...
                        <div class="followup legend field fill-width">
                            ...
                            <div class="field">
                                ...
                                <span class="no-wrap">210 <small>closed</small></span>
                            </div>
                        </div>
                        <div class="field blue fill-width">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width="16" height="16">
                        ...
                        <div class="followup legend field fill-width">
                            <div class="field">
                                ...
                                <span class="no-wrap">15 <small>open</small></span>
                            </div>
                            <div class="field">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width="16" height="16">
                                    <path fill="#d2a8ff" fill-rule="evenodd" d="M5 3.254V3.25v.005a.75.75 0 110-.005v.004zm.45 1.9a2.25 2.25 0 10-1.95.218v5.256a2.25 2.25 0 101.5 0V7.123A5.735 5.735 0 009.25 9h1.378a2.251 2.251 0 100-1.5H9.25a4.25 4.25 0 01-3.8-2.346zM12.75 9a.75.75 0 100-1.5.75.75 0 000 1.5zm-8.5 4.5a.75.75 0 100-1.5.75.75 0 000 1.5z"/>
                                </svg>
                                <span class="no-wrap">1329 <small>merged</small></span>
                            </div>
                            <div class="field">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width="16" height="16">
                            ...
                            <div class="field">
                                ...
                                <span class="no-wrap">199 <small>closed</small></span>
                            </div>
                        </div>
                    </section>
                </div>
